...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 style="color: #fb8c00;">{{__('main.deleted_companies')}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('welcome', app()->getLocale())}}">{{__('main.home')}}</a>
                </li>
                <li class="breadcrumb-item active">{{__('main.deleted_companies')}}</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <table id="example" class="table table-striped table-bordered ml-5" style="width:100% ">
        ...
        <tbody>
            ...
            <tr class="text-center">
                ...
                <td>
                    <a class="btn"
                        href="{{ route('company.delete', ['locale' => app()->getLocale(), 'id' => $company->id]) }}">
                        <i class="fas fa-trash" style="color: #fb8c00; font-size: 30px;"></i>
                    </a>
                </td>
                <td>
                    <a class="btn"
                        href="{{ route('company.restore', ['locale' => app()->getLocale(), 'id' => $company->id]) }}">
