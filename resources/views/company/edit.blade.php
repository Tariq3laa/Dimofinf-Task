...
<li class="nav-item">
    <a class="nav-link"
        href="{{ route(\Illuminate\Support\Facades\Route::currentRouteName(), ['locale' => $locale["value"], 'company' => $company]) }}">
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center">{{__('main.update_company')}}</div>
                <div class="card-body">
                    @if (session('status'))
                    ...
                    <div class="panel-heading">
                        <div class="panel-body">
                            <form method="post"
                                action="{{ route('company.update',['locale' => app()->getLocale(), 'company' => $company]) }}"
